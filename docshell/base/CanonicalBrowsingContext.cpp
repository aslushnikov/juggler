...
void CanonicalBrowsingContext::LoadURI(nsIURI* aURI,
...

  {
    ...
    if (observerService) {
      observerService->NotifyObservers(ToSupports(this), "juggler-navigation-started-browser", NS_ConvertASCIItoUTF16(nsPrintfCString("%lu", loadState->GetLoadIdentifier())).get());
    }
  }
